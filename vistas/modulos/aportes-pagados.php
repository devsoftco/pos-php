...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Administrar Aportes Pagados</li>
    ...
    <div class="box-body">
      ...
      <thead>
        ...
        <tbody>
          ...
          $apo = ControladorAportes::ctrMostrarEstadoAportesPagados($item, $valor);
          ...
          foreach ($apo as $key => $value){
            ...
            <td>'.date("d/m/Y", strtotime($value["mes_pago"])).'</td>';
            ...
            <td>
              ...
              <div class="btn-group">';
                ...
                if($value["aporte_id"] != ""){
                  ...
                  echo '<button class="btn btn-success btnEnviarFactura" idUsuario="'.$value["aporte_id"].'"><i class="fa fa-envelope"></i></button>
