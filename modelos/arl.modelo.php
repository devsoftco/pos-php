...
class ModeloArl{
	...
	static public function MdlMostrarArl($tabla, $item, $valor){
	...
	static public function MdlIngresarArl($tabla, $datos){
	...
	static public function mdlEditarArl($tabla, $datos){
	...
	/*=============================================
	ACTUALIZAR ESTADO ARL
	=============================================*/

	static public function mdlActualizarArl($tabla, $item1, $valor1, $item2, $valor2){
	...
	static public function mdlBorrarArl($tabla, $datos){
