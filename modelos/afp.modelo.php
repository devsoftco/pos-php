...
class ModeloAfp{
	...
	static public function MdlMostrarAfp($tabla, $item, $valor){
	...
	static public function MdlIngresarAfp($tabla, $datos){
	...
	static public function mdlEditarAfp($tabla, $datos){
	...
	/*=============================================
	ACTUALIZAR ESTADO AFP
	=============================================*/

	static public function mdlActualizarAfp($tabla, $item1, $valor1, $item2, $valor2){
	...
	static public function mdlBorrarAfp($tabla, $datos){
