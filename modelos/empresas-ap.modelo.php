...
class ModeloEmpresasAp{
	...
	static public function MdlIngresarEmpresa($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, nit, direccion) VALUES(:nombre, :nit, :direccion)");
	...
	static public function mdlEditarEmpresa($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, nit = :nit, direccion = :direccion WHERE id = :id");
